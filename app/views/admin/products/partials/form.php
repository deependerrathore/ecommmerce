...
<form class="needs-validation" action="<?=$this->postAction?>" method="POST"  enctype="multipart/form-data">
    <div class="form-row">
        ...
        <?=FH::textareaBlock('Description','description',$this->product->description,'Product Description',['class'=>'form-control','rows'=>6, 'cols' => 10],['class'=>'form-group col-md-12'],$this->displayErrors);?>
        <?=FH::imageuploadBlock('file','Upload Product Images','productImages[]','',['class'=>'form-control-file','multiple'=>'multiple'],['class'=>'form-group'],$this->displayErrors);?>
